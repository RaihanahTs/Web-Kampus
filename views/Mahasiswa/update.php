      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="nim" name="nim" value="<?=$mhs_edit->nim?>" type="number" class="form-control">
                </div>
            </div>
            <div class="form-group row">
                <label for="nama" class="col-4 col-form-label">Nama Lengkap</label> 
                <div class="col-8">
                <input id="nama" name="nama" value="<?=$mhs_edit->nama?>" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="tmpt_lahir" name="tmpt_lahir" value="<?=$mhs_edit->tmpt_lahir?>" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                <input id="ipk" name="ipk" value="<?=$mhs_edit->ipk?>" type="text" class="form-control">
                </div>
            </div> 
            <div class="form-group row">
